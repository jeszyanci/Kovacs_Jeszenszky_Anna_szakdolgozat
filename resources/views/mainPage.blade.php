...
<script src="{{ asset('../resources/js/main/myClasses/News.js') }}"></script>
<script src="{{ asset('../resources/js/main/index.js') }}"></script>
...
<section class="menus" style="display: flex; flex-direction: row; height: 100;">
    <div style="display: flex;">
        <div class="menuHolder">
            ...
            <ul>
                <li id="newOrder"   class="box button" onclick="window.location='{{ route('newOrderPage') }}'">Új</li>
                <li id="ordersList" class="box button" onclick="window.location='{{ route('ordersListPage') }}'">Felvett</li>
            </ul>
        </div>
        ...
        <div class="menuHolder">
            ...
            <ul>
                <li id="repair"      class="box button" onclick="window.location='{{ route('newRepairPage') }}'">Javítás</li>
                <li id="repairsList" class="box button" onclick="window.location='{{ route('repairsListPage') }}'">Felvett</li>
            </ul>
        </div>
        ...
        <div class="menuHolder">
            ...
            <ul>
                <li id="log"    class="box button" onClick="window.location='{{ route('logListPage') }}'">Log</li>
                <li id="graphs" class="box button" onClick="window.location='{{ route('graphsPage') }}'">Grafikonok</li>
            </ul>
        </div>
    </div>
    ...
    <div style="display: inline-flex; flex:3; justify-content: flex-end; height: 40px;">
        ...
        <div id="btn-profile" class="box button" onclick="window.location='{{ route('profilePage') }}'" style="float:right; margin-left:20px;">Profil</div>
        <div id="btn-logout"  class="box button" onclick="window.location='{{ route('loginPage') }}'"   style="float:right; margin-left:20px;">Kijelentkezés</div>
    </div>
</section>
