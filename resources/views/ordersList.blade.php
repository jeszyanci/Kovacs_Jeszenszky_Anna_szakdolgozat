...
<script src="{{ asset('../resources/js/main/myClasses/Order.js') }}"></script>
<script src="{{ asset('../resources/js/main/orderList.js')}}"></script>
<script async src="{{ asset('../resources/js/main/newOrder.js')}}"></script>
